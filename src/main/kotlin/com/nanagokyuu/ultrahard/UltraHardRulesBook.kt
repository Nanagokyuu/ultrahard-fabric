		...
		book.set(
			...
			WrittenBookContent(
				...
				listOf(
					...
					Filterable.passThrough(Component.literal("睡眠与跳夜\n\n重伤睡满5秒并首次领取当日治疗后，才锁定整个世界当晚不能跳夜；提前起床不锁定。全服提示：有玩家重伤入睡，今夜将无法跳过。\n\n锁定后，起床、回血、死亡、重登或换维度都不解除，队友不能代跳；自然天亮后失效。每天最多治疗一次。")),
